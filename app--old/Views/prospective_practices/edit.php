        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption font-green-jungle">
                    <span class="caption-subject bold">Edit Prospective Practice [<?= $practice["PracticeName"] ?>]</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form action="<?= base_url(route_to('prospective_practice_update', $practice["PracticeCode"])); ?>" method="POST" class="form-horizontal">
                    <div class="form-body">
