...
<body class=" login">
    <!-- BEGIN LOGO -->
    <div class="logo">
            <img src="<?= base_url(); ?>/assets/pages/img/logo-big.png" alt="" height="80" />
    </div>
    <!-- END LOGO -->
    <!-- BEGIN LOGIN -->
    <div class="content" style="background-color: aliceblue;">
        ...
        <form class="login-form" action="index.html" method="post">
            ...
            <div class="form-group" style="padding-bottom: 40px;">
                <a href="<?= base_url(route_to('initiate_google_oauth')); ?>" class="btn btn-info  btn-block btn-lg">
                    <span>Google</span> <img src="https://www.google.com/images/branding/googleg/1x/googleg_standard_color_128dp.png" height="24">
                </a>
            </div>

            <div class="form-group" style="padding-bottom: 40px;">
                <a href="#" class="btn default btn-block btn-lg">
            ...
            <div class="form-group" style="padding-bottom: 40px; font-size: large; font-weight: bolder; text-align: center;">
              <?php
