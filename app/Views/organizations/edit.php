        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption font-green-jungle">
                    <span class="caption-subject bold">Edit Organization [<?= "{$user["OrgName"]}" ?>]</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form action="<?= base_url(route_to('organization_update', $user["UniqueId"])); ?>" method="POST" class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Organization Name</label>
                            <div class="col-md-4">
                                <input type="text" name="organization_name" value="<?= old('organization_name', $user["OrgName"]) ?>" class="form-control" placeholder="Enter Organization Name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="organization_description" value="<?= old('organization_description', $user["OrgDescr"]) ?>" class="form-control" placeholder="Enter Organization Description">
